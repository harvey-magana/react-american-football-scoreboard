    ...
    <div className="container">
      ...
      <section className="buttons">
        ...
        <div className="awayButtons">
          <button className="awayButtons__touchdown" onClick={() => tigerSetCount( tigerTouchdown + 7 )}>Away Touchdown</button>
          <button className="awayButtons__fieldGoal" onClick={() => tigerFieldCount( tigerFieldGoal + 3 )}>Away Field Goal</button>
        </div>
      </section>
    </div>
  );
